...
Return:
Exit status is the number of errors, 0 on Success
...
def __analyse_html(file_path):
    """This begins to analyze the HTML file
    """
...
def __analyse_css(file_path):
    """This begins to analyze the CSS file
    """
    d = {'output': "json"}
...
def __analyse(file_path):
    """This starts analyse of a file and prints the result
    """
    nb_errors = 0
    try:
        result = None
...
def __files_loop():
    """This is a loop that analyzes for each file from input arguments
    """
    nb_errors = 0
...
if __name__ == "__main__":
    ...
    """This executes tests, then exit. Exit status = number of errors (0 on success)
    """
